...
namespace MapMaker
{
    public partial class SettingForm : Form
    {
        ...
        private void OnOkButtonClicked(object sender, MouseEventArgs e)
        {
            ...
            _form1.MapGrid.RowCount = (int)MapHeight.Value / (int)ChipHeight.Value;
            _form1.MapGrid.ColumnCount = (int)MapWidth.Value / (int)ChipWidth.Value;
            ...
            _form1.MapPreviewBox.Width = (int)MapWidth.Value;
            _form1.MapPreviewBox.Height = (int)MapHeight.Value;
